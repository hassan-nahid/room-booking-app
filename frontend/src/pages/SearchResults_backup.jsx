...
import { Map, List, Filter, SlidersHorizontal, Star, Wifi, Car, Coffee, Waves, Mountain } from "lucide-react";
...
export default function SearchResults() {
  ...
  // Extract search parameters and combine with filters
  const searchCriteria = {
    location: searchParams.get('location') || '',
    checkIn: searchParams.get('checkIn') || '',
    checkOut: searchParams.get('checkOut') || '',
    guests: searchParams.get('guests') || '',
    ...filters, // Include all filter values
  ...
  const properties = searchResponse?.data ? searchResponse.data.map(transformPropertyData) : [];
  ...
  const getActiveFilterCount = () => {
    ...
    if (filters.styleCategory) count++;
    if (filters.bedrooms) count++;
    if (filters.bathrooms) count++;
    if (filters.amenities.length > 0) count++;
    if (filters.instantBook) count++;
    if (filters.isSuperhost) count++;
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                {getActiveFilterCount() > 0 && (
                  <span className="ml-2 bg-gray-900 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                      checked={filters.isSuperhost}
                      onChange={(e) => updateFilter('isSuperhost', e.target.checked)}
                      className="rounded border-gray-300 text-gray-900 focus:ring-gray-900 focus:ring-2"
                    />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!isLoading && !error && getActiveFilterCount() > 0 && (
          <div className="mb-6">
